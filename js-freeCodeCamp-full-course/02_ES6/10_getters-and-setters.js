...
let temp = thermos.temperature; // 24.44 in Celsius. The getter receives the temperature converted to celsius

thermos.temperature = 26; // the setter takes the value in celsius and transform it in fahrenheit so when the getter is called again converts the temperature in fahrenheit to celsius again
