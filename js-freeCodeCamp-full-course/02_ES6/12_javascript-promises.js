...
/* this example will not work in practice because of the condition
...
makeServerRequest3.then(result => console.log(result));
...
makeServerRequest4.catch(error => console.log(error));
